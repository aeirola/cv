...
{\Large\Mundus} \href{http://iki.fi/aeirola}{http://iki.fi/aeirola}
}
...
\gray Job Title & \textbf{Research and Course Assistant}\\
       & Project research on web technologies for embedded systems, as well as assistance for the courses T-106.3101 “Intermediate Course in Programming T2 (the C language)" and T-106.1150 “Computer and Operating system”.
\end{tabularx}
